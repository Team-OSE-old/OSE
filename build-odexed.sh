...
# get current version
MAJOR=$(cat $DIR/vendor/cm/config/common.mk | grep 'CM_VERSION_MAJOR = *' | sed  's/CM_VERSION_MAJOR = //g')
MINOR=$(cat $DIR/vendor/cm/config/common.mk | grep 'CM_VERSION_MINOR = *' | sed  's/CM_VERSION_MINOR = //g')
MAINTENANCE=$(cat $DIR/vendor/cm/config/common.mk | grep 'CM_VERSION_MAINTENANCE = *' | sed  's/CM_VERSION_MAINTENANCE = //g')
...
rm -f out/target/product/*/cm_*-ota-eng.*.zip
