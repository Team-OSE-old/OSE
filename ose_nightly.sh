...
export OSE_BUILD_TYPE=NIGHTLY;
./build-ose.sh -p -o3 -j18 evita;
mv out/target/product/evita/OSE-*.zip /home/www/devs/teamose/OSE/Nightlies/evita;
export OSE_BUILD_TYPE=NIGHTLY;
...
export OSE_BUILD_TYPE=NIGHTLY;
./build-ose.sh -p -o3 -j18 ls980;
mv out/target/product/ls980/OSE-*.zip /home/www/devs/teamose/OSE/Nightlies/ls980;
export OSE_BUILD_TYPE=NIGHTLY;
...
export OSE_BUILD_TYPE=NIGHTLY;
./build-ose.sh -p -o3 -j18 spyder;
mv out/target/product/spyder/OSE-*.zip /home/www/devs/teamose/OSE/Nightlies/spyder;
export OSE_BUILD_TYPE=NIGHTLY;
